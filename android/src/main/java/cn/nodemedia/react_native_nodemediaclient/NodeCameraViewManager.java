...
public class NodeCameraViewManager extends ViewGroupManager<RCTNodeCameraView> {
    ...
    private static final int COMMAND_CAPTURE_PICTURE_ID = 6;
    private static final String COMMAND_CAPTURE_PICTURE_NAME = "capturePicture";
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.of(COMMAND_STARTPREV_NAME, COMMAND_STARTPREV_ID, COMMAND_STOPPREV_NAME, COMMAND_STOPPREV_ID,
                ...
                COMMAND_SWITCH_CAM_ID, COMMAND_SWITCH_FLASH_NAME, COMMAND_SWITCH_FLASH_ID, COMMAND_CAPTURE_PICTURE_NAME, COMMAND_CAPTURE_PICTURE_ID);
    }
    ...
    public void receiveCommand(RCTNodeCameraView root, int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
            ...
            case COMMAND_SWITCH_FLASH_ID:
                ...
                break;
            case COMMAND_CAPTURE_PICTURE_ID:
                root.capturePicture();
                break;
        }
    }
